...
import { PERSONAL_BUILD, personalIdentity, assertUpdatesAllowed } from '../web/server/lib/personal-build.js';
...
const { upstream: UPSTREAM_VERSION, version: APP_VERSION } = personalIdentity(APP_METADATA.version);
...
const registerPackagedUiProtocol = () => {
  ...
  installPackagedUiRequestHandler(createPackagedUiHandler({
