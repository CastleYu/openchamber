...
export const settingsDict = {
  ...
  'settings.openchamber.occupancy.title': 'Performance occupancy',
  'settings.openchamber.occupancy.scenario.label': 'Workload',
  'settings.openchamber.occupancy.scenario.info': 'Pick a background workload, then turn it off or cap how many git diffs it may run at once.',
  'settings.openchamber.occupancy.scenario.aria': 'Select a background workload to configure',
  'settings.openchamber.occupancy.scenario.gitDiffPrefetch': 'Git diff prefetch',
  'settings.openchamber.occupancy.scenario.walkthroughUntrackedDiffs': 'Walkthrough untracked diffs',
  "settings.openchamber.occupancy.scenario.hiddenSurfaceWork": "Work on hidden walkthrough panels",
  'settings.openchamber.occupancy.scenario.browserTabKeepAlive': 'Keep browser tabs alive',
  'settings.openchamber.occupancy.scenario.idlePolling': 'Idle status polling',
  'settings.openchamber.occupancy.enabled': 'Allow this workload',
  'settings.openchamber.occupancy.enabledAria': 'Allow the selected background workload',
  'settings.openchamber.occupancy.concurrency': 'Max concurrent diffs',
  'settings.openchamber.occupancy.concurrencyAria': 'Maximum concurrent git diffs',
  'settings.openchamber.occupancy.concurrencyInfo': 'How many file diffs the Git panel may prefetch at once.',
  'settings.openchamber.occupancy.untrackedConcurrencyInfo': 'How many untracked-file diffs a walkthrough may generate at once.',
  'settings.openchamber.occupancy.maxFiles': 'Max untracked files',
  'settings.openchamber.occupancy.maxFilesAria': 'Maximum untracked files to diff',
  'settings.openchamber.occupancy.maxFilesInfo': 'Walkthrough generation stops after this many untracked files.',
  'settings.openchamber.occupancy.info.gitDiffPrefetch': 'When off, Git no longer preloads file diffs in the background. Open a file to load its diff.',
  'settings.openchamber.occupancy.info.walkthroughUntrackedDiffs': 'When off, walkthroughs skip untracked files instead of diffing every new file against an empty tree.',
  'settings.openchamber.occupancy.info.hiddenSurfaceWork': 'When off, a hidden walkthrough tab does not load git status or generate diffs.',
  'settings.openchamber.occupancy.info.browserTabKeepAlive': 'When off, only the active browser tab stays mounted. Switching back reloads the page.',
  "settings.openchamber.occupancy.info.idlePolling": "When off, optional tray and file-tree polling stops. Active-session recovery stays enabled.",
  ...
  'settings.openchamber.visual.field.mermaidStyle': 'Mermaid style',
  'settings.openchamber.visual.field.mermaidStyleAria': 'Mermaid style',
  'settings.openchamber.visual.option.mermaidStyle.openchamber': 'OpenChamber (default)',
  'settings.openchamber.visual.option.mermaidStyle.native': 'Native',
  ...
  'settings.openchamber.visual.option.mermaidStyle.hand-drawn': 'Hand-drawn',
  'settings.openchamber.visual.option.mermaidStyle.github-light': 'GitHub Light',
  'settings.openchamber.visual.option.mermaidStyle.github-dark': 'GitHub Dark',
  ...
  'settings.mcp.page.status.lastFailedAt': "Last failed: {time}",
  'settings.mcp.page.actions.viewLogs': "View logs",
  'settings.page.logs.title': "Logs",
  'settings.page.logs.description': "OpenChamber runtime logs for troubleshooting.",
  'settings.logs.section.title': "Log files",
  'settings.logs.currentFile': "Current file",
  'settings.logs.path': "Location",
  'settings.logs.openWithDefault': "Open with default program",
  'settings.logs.openFolder': "Show in folder",
  'settings.logs.download': "Download",
  'settings.logs.downloadFileAria': "Download {name}",
  'settings.logs.copyPath': "Copy path",
  'settings.logs.copied': "Path copied",
  'settings.logs.copyFailed': "Failed to copy the path",
  'settings.logs.openFailed': "Failed to open the log file",
  'settings.logs.downloadFailed': "Failed to download the log file",
  'settings.logs.empty': "No log files yet.",
  'settings.logs.retainHint': "Logs roll over daily, and older files are cleaned up automatically.",
  'settings.mcp.page.failure.windowsCmdShim.cause': "The command could not start on Windows (npm shim problem).",
  'settings.mcp.page.failureHint.windowsCmdShim': "On Windows, npm-based local servers usually run through cmd: set the command to cmd with the arguments /c, npx, and your package.",
  'settings.mcp.page.failure.commandNotFound.cause': "The command or package could not be found.",
  'settings.mcp.page.failureHint.commandNotFound': "Check the command and package name, and make sure the required runtime is installed and on PATH.",
  'settings.mcp.page.failure.connectionRefused.cause': "The server address could not be reached.",
  'settings.mcp.page.failureHint.connectionRefused': "Check the URL, host, and port, and confirm the server is running and reachable.",
  'settings.mcp.page.failure.processClosed.cause': "The server process closed the connection unexpectedly.",
  'settings.mcp.page.failureHint.processClosed': "Run the command manually in a terminal to see its startup error — it likely crashed or exited immediately.",
  'settings.mcp.page.failure.timeout.cause': "The server did not respond in time.",
  'settings.mcp.page.failureHint.timeout': "Increase the timeout in the advanced options, or check whether the server is slow to start.",
  'settings.mcp.page.failure.oauthRegistration.cause': "The OAuth client registration was rejected.",
  'settings.mcp.page.failureHint.oauthRegistration': "Register a client with the provider, or provide a client ID and secret in the authorization section.",
  'settings.mcp.page.failure.authRejected.cause': "The server rejected the credentials.",
  'settings.mcp.page.failureHint.authRejected': "Check the configured headers and environment variables for a valid API key or token.",
  'settings.mcp.page.failure.certificate.cause': "The TLS certificate could not be trusted.",
  'settings.mcp.page.failureHint.certificate': "Fix the server certificate, or use an endpoint with a trusted certificate chain.",
  'settings.mcp.page.failure.wrongAddress.cause': "The server URL does not point to a valid endpoint.",
  'settings.mcp.page.failureHint.wrongAddress': "Verify the server URL, including the MCP endpoint path (often /mcp or /sse).",
  'settings.logs.unavailable': "Log information is not available.",
