...
export const dict = {
  ...
  'fileOpening.previewFailed': "This file cannot be previewed. Retry or open it in a system application.",
  'fileOpening.retry': "Retry",
  'fileOpening.archiveReadOnly': "Directory listing only. No files are extracted.",
  'fileOpening.name': "Name",
  'fileOpening.size': "Size (bytes)",
  'fileOpening.compressed': "Compressed (bytes)",
  'fileOpening.actionFailed': "Could not complete the file operation.",
  'fileOpening.saveAs': "Save as…",
  'fileOpening.saved': "Copy saved",
  'fileOpening.systemOpen': "System open",
  'fileOpening.chooseApp': "Choose application…",
  'fileOpening.reveal': "Open containing folder",
  'fileOpening.unsaved': "This file has unsaved changes.",
  'fileOpening.openDisk': "Open disk version",
  'fileOpening.saveOpen': "Save and open",
  'fileOpening.explorer': "Open in file manager",
  'fileOpening.open': "Open",
  ...
  'gitView.monitor.autoOff': 'Paused',
  'gitView.monitor.autoAria': 'Toggle automatic git status monitoring for this project',
  'gitView.monitor.autoTooltip': 'When paused, this project does not prefetch diffs or refresh git status in the background. Use refresh to load the current tree.',
  'gitView.monitor.refresh': 'Refresh git status',
  'gitView.monitor.refreshAria': 'Refresh git status for this project',
  ...
  'markdownRenderer.diagram.downloadPng': 'Download PNG',
  'markdownRenderer.diagram.downloadSource': 'Download source',
  'markdownRenderer.diagram.renderFailed': 'Diagram could not be rendered. The source is shown below.',
  'markdownRenderer.diagram.exportFailed': 'Could not export the diagram.',
