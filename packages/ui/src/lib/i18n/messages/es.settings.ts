...
export const settingsDict = {
  'settings.page.update-history.title': "Historial de actualizaciones",
  'settings.page.update-history.description': "Actualizaciones oficiales y personales desde 1.22.0. Las entradas marcadas como «not merged» no se incluyen en esta versión.",
  'settings.history.source': "Origen",
  'settings.history.all': "Todas",
  'settings.history.official': "Oficiales",
  'settings.history.personal': "Personales",
  'settings.history.surface': "Aplicación",
  'settings.history.app': "Aplicación principal",
  'settings.history.new': "Novedades",
  'settings.history.improvements': "Mejoras",
  'settings.history.fixes': "Correcciones",
  'settings.history.misc': "Otros",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.occupancy.title": "Ocupación de rendimiento",
  "settings.openchamber.occupancy.scenario.label": "Trabajo en segundo plano",
  "settings.openchamber.occupancy.scenario.info": "Elige un trabajo, apágalo o limita cuántos diffs de git puede lanzar a la vez.",
  "settings.openchamber.occupancy.scenario.aria": "Seleccionar el trabajo en segundo plano a configurar",
  "settings.openchamber.occupancy.scenario.gitDiffPrefetch": "Precarga de diffs de Git",
  "settings.openchamber.occupancy.scenario.walkthroughUntrackedDiffs": "Diffs de archivos sin seguimiento del walkthrough",
  "settings.openchamber.occupancy.scenario.hiddenSurfaceWork": "Seguir trabajando en paneles walkthrough ocultos",
  "settings.openchamber.occupancy.scenario.browserTabKeepAlive": "Mantener pestañas del navegador vivas",
  "settings.openchamber.occupancy.scenario.idlePolling": "Sondeo de estado en inactividad",
  "settings.openchamber.occupancy.enabled": "Permitir este trabajo",
  "settings.openchamber.occupancy.enabledAria": "Permitir el trabajo en segundo plano seleccionado",
  "settings.openchamber.occupancy.concurrency": "Diffs simultáneos máx.",
  "settings.openchamber.occupancy.concurrencyAria": "Número máximo de diffs de git simultáneos",
  "settings.openchamber.occupancy.concurrencyInfo": "Cuántos diffs de archivo puede precargar a la vez el panel Git.",
  "settings.openchamber.occupancy.untrackedConcurrencyInfo": "Cuántos archivos sin seguimiento puede difer a la vez un walkthrough.",
  "settings.openchamber.occupancy.maxFiles": "Archivos sin seguimiento máx.",
  "settings.openchamber.occupancy.maxFilesAria": "Máximo de archivos sin seguimiento a difer",
  "settings.openchamber.occupancy.maxFilesInfo": "La generación del walkthrough se detiene tras este número de archivos sin seguimiento.",
  "settings.openchamber.occupancy.info.gitDiffPrefetch": "Si está apagado, Git ya no precarga diffs en segundo plano. Abre un archivo para cargar su diff.",
  "settings.openchamber.occupancy.info.walkthroughUntrackedDiffs": "Si está apagado, el walkthrough omite los archivos sin seguimiento en lugar de diferlos contra un árbol vacío.",
  "settings.openchamber.occupancy.info.hiddenSurfaceWork": "Si está apagado, una pestaña de walkthrough oculta no carga el estado git ni genera diffs.",
  "settings.openchamber.occupancy.info.browserTabKeepAlive": "Si está apagado, solo permanece montada la pestaña del navegador activa. Volver recarga la página.",
  "settings.openchamber.occupancy.info.idlePolling": "Al desactivar, se detienen las consultas opcionales de la bandeja y del árbol de archivos. Se mantiene la recuperación del estado de las sesiones activas.",
  ...
  'settings.openchamber.visual.field.mermaidStyle': 'Estilo de Mermaid',
  'settings.openchamber.visual.field.mermaidStyleAria': 'Estilo de Mermaid',
 'settings.openchamber.visual.option.mermaidStyle.openchamber': 'OpenChamber (predeterminado)',
 'settings.openchamber.visual.option.mermaidStyle.native': 'Nativo',
 'settings.openchamber.visual.option.mermaidStyle.forest': 'Forest',
 'settings.openchamber.visual.option.mermaidStyle.neutral': 'Neutro',
 'settings.openchamber.visual.option.mermaidStyle.hand-drawn': 'Dibujado a mano',
  'settings.openchamber.visual.option.mermaidStyle.github-light': 'GitHub claro',
  'settings.openchamber.visual.option.mermaidStyle.github-dark': 'GitHub oscuro',
  ...
  'settings.mcp.page.status.lastFailedAt': "Último fallo: {time}",
  'settings.mcp.page.actions.viewLogs': "Ver registros",
  'settings.page.logs.title': "Registros",
  'settings.page.logs.description': "Registros de ejecución de OpenChamber para diagnóstico.",
  'settings.logs.section.title': "Archivos de registro",
  'settings.logs.currentFile': "Archivo actual",
  'settings.logs.path': "Ubicación",
  'settings.logs.openWithDefault': "Abrir con el programa predeterminado",
  'settings.logs.openFolder': "Mostrar en la carpeta",
  'settings.logs.download': "Descargar",
  'settings.logs.downloadFileAria': "Descargar {name}",
  'settings.logs.copyPath': "Copiar ruta",
  'settings.logs.copied': "Ruta copiada",
  'settings.logs.copyFailed': "No se pudo copiar la ruta",
  'settings.logs.openFailed': "No se pudo abrir el archivo de registro",
  'settings.logs.downloadFailed': "No se pudo descargar el archivo de registro",
  'settings.logs.empty': "Aún no hay archivos de registro.",
  'settings.logs.retainHint': "Los registros rotan a diario y los archivos antiguos se limpian automáticamente.",
  'settings.mcp.page.failure.windowsCmdShim.cause': "El comando no pudo iniciarse en Windows (problema del shim de npm).",
  'settings.mcp.page.failureHint.windowsCmdShim': "En Windows, los servidores locales basados en npm suelen ejecutarse mediante cmd: usa el comando cmd con los argumentos /c, npx y tu paquete.",
  'settings.mcp.page.failure.commandNotFound.cause': "No se encontró el comando o el paquete.",
  'settings.mcp.page.failureHint.commandNotFound': "Revisa el comando y el nombre del paquete, y asegúrate de que el runtime necesario esté instalado y en el PATH.",
  'settings.mcp.page.failure.connectionRefused.cause': "No se pudo alcanzar la dirección del servidor.",
  'settings.mcp.page.failureHint.connectionRefused': "Revisa la URL, el host y el puerto, y confirma que el servidor está en ejecución y accesible.",
  'settings.mcp.page.failure.processClosed.cause': "El proceso del servidor cerró la conexión inesperadamente.",
  'settings.mcp.page.failureHint.processClosed': "Ejecuta el comando manualmente en una terminal para ver el error de arranque; probablemente se bloqueó o salió de inmediato.",
  'settings.mcp.page.failure.timeout.cause': "El servidor no respondió a tiempo.",
  'settings.mcp.page.failureHint.timeout': "Aumenta el tiempo de espera en las opciones avanzadas o comprueba si el servidor tarda en arrancar.",
  'settings.mcp.page.failure.oauthRegistration.cause': "El registro del cliente OAuth fue rechazado.",
  'settings.mcp.page.failureHint.oauthRegistration': "Registra un cliente con el proveedor o indica un ID y secreto de cliente en la sección de autorización.",
  'settings.mcp.page.failure.authRejected.cause': "El servidor rechazó las credenciales.",
  'settings.mcp.page.failureHint.authRejected': "Revisa las cabeceras y variables de entorno configuradas: la clave de API o el token debe ser válido.",
  'settings.mcp.page.failure.certificate.cause': "El certificado TLS no es de confianza.",
  'settings.mcp.page.failureHint.certificate': "Corrige el certificado del servidor o usa un punto de conexión con una cadena de certificados de confianza.",
  'settings.mcp.page.failure.wrongAddress.cause': "La URL del servidor no apunta a un punto de conexión válido.",
  'settings.mcp.page.failureHint.wrongAddress': "Verifica la URL del servidor, incluida la ruta del punto de conexión MCP (normalmente /mcp o /sse).",
  'settings.logs.unavailable': "La información de registros no está disponible.",
