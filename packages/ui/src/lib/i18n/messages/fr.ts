...
export const dict = {
  ...
  'fileOpening.previewFailed': "Aperçu impossible. Réessayez ou ouvrez avec une application système.",
  'fileOpening.retry': "Réessayer",
  'fileOpening.archiveReadOnly': "Liste uniquement. Aucun fichier n’est extrait.",
  'fileOpening.name': "Nom",
  'fileOpening.size': "Taille (octets)",
  'fileOpening.compressed': "Compressé (octets)",
  'fileOpening.actionFailed': "Impossible de terminer l’opération.",
  'fileOpening.saveAs': "Enregistrer sous…",
  'fileOpening.saved': "Copie enregistrée",
  'fileOpening.systemOpen': "Ouvrir avec le système",
  'fileOpening.chooseApp': "Choisir une application…",
  'fileOpening.reveal': "Ouvrir le dossier parent",
  'fileOpening.unsaved': "Ce fichier comporte des modifications non enregistrées.",
  'fileOpening.openDisk': "Ouvrir la version enregistrée",
  'fileOpening.saveOpen': "Enregistrer et ouvrir",
  'fileOpening.explorer': "Ouvrir dans le gestionnaire de fichiers",
  'fileOpening.open': "Ouvrir",
  ...
  'markdownRenderer.diagram.downloadPng': 'Télécharger le PNG',
  'markdownRenderer.diagram.downloadSource': 'Télécharger la source',
  'markdownRenderer.diagram.renderFailed': 'Le diagramme n’a pas pu être rendu. La source est affichée ci-dessous.',
  'markdownRenderer.diagram.exportFailed': 'Impossible d’exporter le diagramme.',
