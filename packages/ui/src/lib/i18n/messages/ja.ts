...
export const dict: Record<I18nKey, string> = {
  ...
  'fileOpening.previewFailed': "プレビューできません。再試行するか、システムのアプリで開いてください。",
  'fileOpening.retry': "再試行",
  'fileOpening.archiveReadOnly': "一覧のみ表示します。ファイルは展開されません。",
  'fileOpening.name': "名前",
  'fileOpening.size': "サイズ（バイト）",
  'fileOpening.compressed': "圧縮後（バイト）",
  'fileOpening.actionFailed': "ファイル操作を完了できませんでした。",
  'fileOpening.saveAs': "名前を付けて保存…",
  'fileOpening.saved': "コピーを保存しました",
  'fileOpening.systemOpen': "システムで開く",
  'fileOpening.chooseApp': "アプリを選択…",
  'fileOpening.reveal': "保存先フォルダーを開く",
  'fileOpening.unsaved': "未保存の変更があります。",
  'fileOpening.openDisk': "ディスク上の内容を開く",
  'fileOpening.saveOpen': "保存して開く",
  'fileOpening.explorer': "ファイルマネージャーで開く",
  'fileOpening.open': "開く",
  'performance.export': '診断情報をエクスポート',
  ...
  'gitView.monitor.autoOn': '自動監視',
  'gitView.monitor.autoOff': '停止中',
  'gitView.monitor.autoAria': 'このプロジェクトの自動 git 状態監視を切り替え',
  'gitView.monitor.autoTooltip': '停止中は、このプロジェクトの diff 先読みもバックグラウンドの git 更新もしません。更新ボタンで現在の作業ツリーを読み込みます。',
  'gitView.monitor.refresh': 'git 状態を更新',
  'gitView.monitor.refreshAria': 'このプロジェクトの git 状態を更新',
  ...
  'markdownRenderer.diagram.downloadPng': 'PNGをダウンロード',
  'markdownRenderer.diagram.downloadSource': 'ソースをダウンロード',
  'markdownRenderer.diagram.renderFailed': 'ダイアグラムを描画できませんでした。ソースを以下に表示します。',
  'markdownRenderer.diagram.exportFailed': 'ダイアグラムをエクスポートできませんでした。',
