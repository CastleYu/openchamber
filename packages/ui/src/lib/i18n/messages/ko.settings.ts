...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.occupancy.title': '성능 점유',
  'settings.openchamber.occupancy.scenario.label': '백그라운드 작업',
  'settings.openchamber.occupancy.scenario.info': '작업을 고른 다음 끄거나, 동시에 돌릴 git diff 수를 제한하세요.',
  'settings.openchamber.occupancy.scenario.aria': '설정할 백그라운드 작업 선택',
  'settings.openchamber.occupancy.scenario.gitDiffPrefetch': 'Git diff 미리 가져오기',
  'settings.openchamber.occupancy.scenario.walkthroughUntrackedDiffs': 'Walkthrough 추적되지 않은 파일 diff',
  "settings.openchamber.occupancy.scenario.hiddenSurfaceWork": "숨겨진 Walkthrough 패널 계속 작업",
  'settings.openchamber.occupancy.scenario.browserTabKeepAlive': '브라우저 탭 유지',
  'settings.openchamber.occupancy.scenario.idlePolling': '유휴 상태 폴링',
  'settings.openchamber.occupancy.enabled': '이 작업 허용',
  'settings.openchamber.occupancy.enabledAria': '선택한 백그라운드 작업 허용',
  'settings.openchamber.occupancy.concurrency': '최대 동시 diff 수',
  'settings.openchamber.occupancy.concurrencyAria': 'git diff 최대 동시 실행 수',
  'settings.openchamber.occupancy.concurrencyInfo': 'Git 패널이 한 번에 미리 가져오는 파일 diff 수입니다.',
  'settings.openchamber.occupancy.untrackedConcurrencyInfo': 'Walkthrough가 한 번에 diff하는 추적되지 않은 파일 수입니다.',
  'settings.openchamber.occupancy.maxFiles': '최대 추적되지 않은 파일',
  'settings.openchamber.occupancy.maxFilesAria': 'diff할 추적되지 않은 파일 최대 개수',
  'settings.openchamber.occupancy.maxFilesInfo': 'Walkthrough는 이 개수의 추적되지 않은 파일에서 멈춥니다.',
  'settings.openchamber.occupancy.info.gitDiffPrefetch': '끄면 Git이 백그라운드에서 파일 diff를 미리 가져오지 않습니다. 파일을 열 때 불러옵니다.',
  'settings.openchamber.occupancy.info.walkthroughUntrackedDiffs': '끄면 Walkthrough가 추적되지 않은 파일을 빈 트리에 대해 diff하지 않습니다.',
  'settings.openchamber.occupancy.info.hiddenSurfaceWork': '끄면 숨겨진 Walkthrough 탭이 git 상태를 읽거나 diff를 만들지 않습니다.',
  'settings.openchamber.occupancy.info.browserTabKeepAlive': '끄면 현재 브라우저 탭만 남습니다. 다시 전환하면 페이지를 다시 로드합니다.',
  "settings.openchamber.occupancy.info.idlePolling": "끄면 트레이와 파일 트리의 선택적 폴링을 중지합니다. 활성 세션의 상태 복구 확인은 유지합니다.",
  ...
  'settings.openchamber.visual.field.mermaidStyle': 'Mermaid 스타일',
  'settings.openchamber.visual.field.mermaidStyleAria': 'Mermaid 스타일',
 'settings.openchamber.visual.option.mermaidStyle.openchamber': 'OpenChamber (기본값)',
 'settings.openchamber.visual.option.mermaidStyle.native': '네이티브',
 ...
 'settings.openchamber.visual.option.mermaidStyle.hand-drawn': '손그림',
  'settings.openchamber.visual.option.mermaidStyle.github-light': 'GitHub 라이트',
  'settings.openchamber.visual.option.mermaidStyle.github-dark': 'GitHub 다크',
  ...
  'settings.mcp.page.status.lastFailedAt': "마지막 실패: {time}",
  'settings.mcp.page.actions.viewLogs': "로그 보기",
  'settings.page.logs.title': "로그",
  'settings.page.logs.description': "OpenChamber 런타임 로그. 문제 해결에 사용합니다.",
  'settings.logs.section.title': "로그 파일",
  'settings.logs.currentFile': "현재 파일",
  'settings.logs.path': "위치",
  'settings.logs.openWithDefault': "기본 프로그램으로 열기",
  'settings.logs.openFolder': "폴더에서 표시",
  'settings.logs.download': "다운로드",
  'settings.logs.downloadFileAria': "{name} 다운로드",
  'settings.logs.copyPath': "경로 복사",
  'settings.logs.copied': "경로가 복사되었습니다",
  'settings.logs.copyFailed': "경로 복사 실패",
  'settings.logs.openFailed': "로그 파일을 열지 못했습니다",
  'settings.logs.downloadFailed': "로그 파일 다운로드 실패",
  'settings.logs.empty': "아직 로그 파일이 없습니다.",
  'settings.logs.retainHint': "로그는 매일 순환되며 오래된 파일은 자동으로 정리됩니다.",
  'settings.mcp.page.failure.windowsCmdShim.cause': "Windows에서 명령을 시작하지 못했습니다(npm shim 문제).",
  'settings.mcp.page.failureHint.windowsCmdShim': "Windows에서는 npm 기반 로컬 서버를 보통 cmd로 실행합니다: 명령을 cmd로, 인수를 /c, npx, 패키지 이름 순으로 지정하세요.",
  'settings.mcp.page.failure.commandNotFound.cause': "명령 또는 패키지를 찾을 수 없습니다.",
  'settings.mcp.page.failureHint.commandNotFound': "명령과 패키지 이름을 확인하고, 필요한 런타임이 설치되어 PATH에 있는지 확인하세요.",
  'settings.mcp.page.failure.connectionRefused.cause': "서버 주소에 연결할 수 없습니다.",
  'settings.mcp.page.failureHint.connectionRefused': "URL, 호스트, 포트를 확인하고 서버가 실행 중이며 접근 가능한지 확인하세요.",
  'settings.mcp.page.failure.processClosed.cause': "서버 프로세스가 예기치 않게 연결을 종료했습니다.",
  'settings.mcp.page.failureHint.processClosed': "터미널에서 명령을 직접 실행해 시작 오류를 확인하세요. 크래시하거나 즉시 종료되었을 가능성이 있습니다.",
  'settings.mcp.page.failure.timeout.cause': "서버가 시간 내에 응답하지 않았습니다.",
  'settings.mcp.page.failureHint.timeout': "고급 옵션에서 타임아웃을 늘리거나 서버 시작이 느린지 확인하세요.",
  'settings.mcp.page.failure.oauthRegistration.cause': "OAuth 클라이언트 등록이 거부되었습니다.",
  'settings.mcp.page.failureHint.oauthRegistration': "공급자에 클라이언트를 등록하거나 인증 섹션에 클라이언트 ID와 시크릿을 입력하세요.",
  'settings.mcp.page.failure.authRejected.cause': "서버가 자격 증명을 거부했습니다.",
  'settings.mcp.page.failureHint.authRejected': "구성된 헤더와 환경 변수의 API 키 또는 토큰이 유효한지 확인하세요.",
  'settings.mcp.page.failure.certificate.cause': "TLS 인증서를 신뢰할 수 없습니다.",
  'settings.mcp.page.failureHint.certificate': "서버 인증서를 수정하거나 신뢰할 수 있는 인증서 체인을 사용하는 엔드포인트를 사용하세요.",
  'settings.mcp.page.failure.wrongAddress.cause': "서버 URL이 유효한 엔드포인트를 가리키지 않습니다.",
  'settings.mcp.page.failureHint.wrongAddress': "서버 URL과 MCP 엔드포인트 경로(보통 /mcp 또는 /sse)를 확인하세요.",
  'settings.logs.unavailable': "로그 정보를 사용할 수 없습니다.",
