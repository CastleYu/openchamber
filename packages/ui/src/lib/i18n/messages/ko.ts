...
export const dict: Record<I18nKey, string> = {
  ...
  'fileOpening.previewFailed': "미리 볼 수 없습니다. 다시 시도하거나 시스템 앱으로 여세요.",
  'fileOpening.retry': "다시 시도",
  'fileOpening.archiveReadOnly': "목록만 표시하며 파일을 압축 해제하지 않습니다.",
  'fileOpening.name': "이름",
  'fileOpening.size': "크기(바이트)",
  'fileOpening.compressed': "압축 크기(바이트)",
  'fileOpening.actionFailed': "파일 작업을 완료하지 못했습니다.",
  'fileOpening.saveAs': "다른 이름으로 저장…",
  'fileOpening.saved': "사본 저장됨",
  'fileOpening.systemOpen': "시스템 앱으로 열기",
  'fileOpening.chooseApp': "앱 선택…",
  'fileOpening.reveal': "파일이 있는 폴더 열기",
  'fileOpening.unsaved': "저장하지 않은 변경 사항이 있습니다.",
  'fileOpening.openDisk': "디스크 버전 열기",
  'fileOpening.saveOpen': "저장 후 열기",
  'fileOpening.explorer': "파일 관리자에서 열기",
  'fileOpening.open': "열기",
  ...
  'markdownRenderer.diagram.downloadPng': 'PNG 다운로드',
  'markdownRenderer.diagram.downloadSource': '소스 다운로드',
  'markdownRenderer.diagram.renderFailed': '다이어그램을 렌더링할 수 없습니다. 아래에 소스를 표시합니다.',
  'markdownRenderer.diagram.exportFailed': '다이어그램을 내보낼 수 없습니다.',
