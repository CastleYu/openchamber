...
export const settingsDict = {
  ...
  'settings.openchamber.occupancy.title': 'Obciążenie wydajności',
  'settings.openchamber.occupancy.scenario.label': 'Praca w tle',
  'settings.openchamber.occupancy.scenario.info': 'Wybierz pracę, wyłącz ją albo ogranicz, ile git diff może uruchomić naraz.',
  'settings.openchamber.occupancy.scenario.aria': 'Wybierz pracę w tle do skonfigurowania',
  'settings.openchamber.occupancy.scenario.gitDiffPrefetch': 'Wstępne pobieranie diffów Git',
  'settings.openchamber.occupancy.scenario.walkthroughUntrackedDiffs': 'Diffy nieśledzonych plików w walkthrough',
  "settings.openchamber.occupancy.scenario.hiddenSurfaceWork": "Kontynuuj pracę ukrytych paneli walkthrough",
  'settings.openchamber.occupancy.scenario.browserTabKeepAlive': 'Utrzymuj karty przeglądarki przy życiu',
  'settings.openchamber.occupancy.scenario.idlePolling': 'Odpytywanie stanu w bezczynności',
  'settings.openchamber.occupancy.enabled': 'Zezwól na tę pracę',
  'settings.openchamber.occupancy.enabledAria': 'Zezwól na wybraną pracę w tle',
  'settings.openchamber.occupancy.concurrency': 'Maks. równoległych diffów',
  'settings.openchamber.occupancy.concurrencyAria': 'Maksymalna liczba równoległych git diff',
  'settings.openchamber.occupancy.concurrencyInfo': 'Ile diffów plików panel Git może wstępnie pobrać naraz.',
  'settings.openchamber.occupancy.untrackedConcurrencyInfo': 'Ile nieśledzonych plików walkthrough może porównać naraz.',
  'settings.openchamber.occupancy.maxFiles': 'Maks. nieśledzonych plików',
  'settings.openchamber.occupancy.maxFilesAria': 'Maksymalna liczba nieśledzonych plików do porównania',
  'settings.openchamber.occupancy.maxFilesInfo': 'Generowanie walkthrough zatrzymuje się po tylu nieśledzonych plikach.',
  'settings.openchamber.occupancy.info.gitDiffPrefetch': 'Wyłączone — Git nie wstępnie pobiera już diffów w tle. Otwórz plik, aby wczytać jego diff.',
  'settings.openchamber.occupancy.info.walkthroughUntrackedDiffs': 'Wyłączone — walkthrough pomija nieśledzone pliki zamiast porównywać je z pustym drzewem.',
  'settings.openchamber.occupancy.info.hiddenSurfaceWork': 'Wyłączone — ukryta karta walkthrough nie wczytuje stanu git ani nie generuje diffów.',
  'settings.openchamber.occupancy.info.browserTabKeepAlive': 'Wyłączone — zostaje tylko aktywna karta przeglądarki. Powrót przeładowuje stronę.',
  "settings.openchamber.occupancy.info.idlePolling": "Wyłączenie zatrzymuje opcjonalne odpytywanie zasobnika i drzewa plików. Odzyskiwanie stanu aktywnych sesji pozostaje włączone.",
  ...
  'settings.openchamber.visual.field.mermaidStyle': 'Styl Mermaid',
  'settings.openchamber.visual.field.mermaidStyleAria': 'Styl Mermaid',
 'settings.openchamber.visual.option.mermaidStyle.openchamber': 'OpenChamber (domyślny)',
 'settings.openchamber.visual.option.mermaidStyle.native': 'Natywny',
 'settings.openchamber.visual.option.mermaidStyle.forest': 'Forest',
 'settings.openchamber.visual.option.mermaidStyle.neutral': 'Neutralny',
 'settings.openchamber.visual.option.mermaidStyle.hand-drawn': 'Rysowany odręcznie',
  'settings.openchamber.visual.option.mermaidStyle.github-light': 'GitHub jasny',
  'settings.openchamber.visual.option.mermaidStyle.github-dark': 'GitHub ciemny',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.mcp.page.status.lastFailedAt': "Ostatnie niepowodzenie: {time}",
  'settings.mcp.page.actions.viewLogs': "Pokaż logi",
  'settings.page.logs.title': "Logi",
  'settings.page.logs.description': "Logi działania OpenChamber do diagnostyki.",
  'settings.logs.section.title': "Pliki dziennika",
  'settings.logs.currentFile': "Bieżący plik",
  'settings.logs.path': "Lokalizacja",
  'settings.logs.openWithDefault': "Otwórz w programie domyślnym",
  'settings.logs.openFolder': "Pokaż w folderze",
  'settings.logs.download': "Pobierz",
  'settings.logs.downloadFileAria': "Pobierz {name}",
  'settings.logs.copyPath': "Kopiuj ścieżkę",
  'settings.logs.copied': "Ścieżka skopiowana",
  'settings.logs.copyFailed': "Nie udało się skopiować ścieżki",
  'settings.logs.openFailed': "Nie udało się otworzyć pliku dziennika",
  'settings.logs.downloadFailed': "Nie udało się pobrać pliku dziennika",
  'settings.logs.empty': "Nie ma jeszcze plików dziennika.",
  'settings.logs.retainHint': "Dziennik rotuje codziennie, a starsze pliki są automatycznie usuwane.",
  'settings.mcp.page.failure.windowsCmdShim.cause': "Nie można uruchomić polecenia w systemie Windows (problem z shim npm).",
  'settings.mcp.page.failureHint.windowsCmdShim': "W systemie Windows lokalne serwery oparte na npm zwykle uruchamia się przez cmd: ustaw polecenie na cmd z argumentami /c, npx i nazwą pakietu.",
  'settings.mcp.page.failure.commandNotFound.cause': "Nie znaleziono polecenia ani pakietu.",
  'settings.mcp.page.failureHint.commandNotFound': "Sprawdź polecenie i nazwę pakietu oraz upewnij się, że wymagane środowisko jest zainstalowane i dostępne w PATH.",
  'settings.mcp.page.failure.connectionRefused.cause': "Nie można połączyć się z adresem serwera.",
  'settings.mcp.page.failureHint.connectionRefused': "Sprawdź adres URL, host i port oraz upewnij się, że serwer działa i jest osiągalny.",
  'settings.mcp.page.failure.processClosed.cause': "Proces serwera nieoczekiwanie zamknął połączenie.",
  'settings.mcp.page.failureHint.processClosed': "Uruchom polecenie ręcznie w terminalu, aby zobaczyć błąd startu — prawdopodobnie uległ awarii lub zakończył się od razu.",
  'settings.mcp.page.failure.timeout.cause': "Serwer nie odpowiedział w terminie.",
  'settings.mcp.page.failureHint.timeout': "Zwiększ limit czasu w opcjach zaawansowanych lub sprawdź, czy serwer wolno się uruchamia.",
  'settings.mcp.page.failure.oauthRegistration.cause': "Rejestracja klienta OAuth została odrzucona.",
  'settings.mcp.page.failureHint.oauthRegistration': "Zarejestruj klienta u dostawcy lub podaj identyfikator i sekret klienta w sekcji autoryzacji.",
  'settings.mcp.page.failure.authRejected.cause': "Serwer odrzucił dane uwierzytelniające.",
  'settings.mcp.page.failureHint.authRejected': "Sprawdź skonfigurowane nagłówki i zmienne środowiskowe: klucz API lub token musi być prawidłowy.",
  'settings.mcp.page.failure.certificate.cause': "Certyfikat TLS nie jest zaufany.",
  'settings.mcp.page.failureHint.certificate': "Napraw certyfikat serwera lub użyj punktu końcowego z zaufanym łańcuchem certyfikatów.",
  'settings.mcp.page.failure.wrongAddress.cause': "Adres URL serwera nie wskazuje prawidłowego punktu końcowego.",
  'settings.mcp.page.failureHint.wrongAddress': "Zweryfikuj adres URL serwera, łącznie ze ścieżką punktu końcowego MCP (zwykle /mcp lub /sse).",
  'settings.logs.unavailable': "Informacje dziennika są niedostępne.",
