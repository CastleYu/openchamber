...
export const dict: Record<I18nKey, string> = {
  ...
  'fileOpening.previewFailed': "Podgląd niedostępny. Spróbuj ponownie lub otwórz w aplikacji systemowej.",
  'fileOpening.retry': "Spróbuj ponownie",
  'fileOpening.archiveReadOnly': "Tylko lista zawartości. Pliki nie są rozpakowywane.",
  'fileOpening.name': "Nazwa",
  'fileOpening.size': "Rozmiar (bajty)",
  'fileOpening.compressed': "Po kompresji (bajty)",
  'fileOpening.actionFailed': "Nie udało się ukończyć operacji.",
  'fileOpening.saveAs': "Zapisz jako…",
  'fileOpening.saved': "Kopia zapisana",
  'fileOpening.systemOpen': "Otwórz w systemie",
  'fileOpening.chooseApp': "Wybierz aplikację…",
  'fileOpening.reveal': "Otwórz folder nadrzędny",
  'fileOpening.unsaved': "Plik zawiera niezapisane zmiany.",
  'fileOpening.openDisk': "Otwórz zapisaną wersję",
  'fileOpening.saveOpen': "Zapisz i otwórz",
  'fileOpening.explorer': "Otwórz w menedżerze plików",
  'fileOpening.open': "Otwórz",
  'performance.export': 'Eksportuj diagnostykę',
  'performance.title': "Wydajność",
  'performance.memory': "Pamięć",
  'performance.cpu': "CPU",
  'performance.processes': "Procesy",
  'performance.metric': "Metryka nagłówka",
  'performance.paused': "Pomiar wstrzymany",
  'performance.failed': "Błąd pomiaru. Poprzednie dane mogą być nieaktualne.",
  'performance.loading': "Pomiar…",
  'performance.scope': "Aktywny serwer i jego procesy Electron, OpenCode, MCP i terminale. Bez usług zewnętrznych i klientów przeglądarkowych.",
  'performance.pause': "Wstrzymaj",
  'performance.resume': "Wznów",
  'performance.history': "Ostatnie 30 próbek · co 5 sekund",
  'performance.accounting': "Pamięć sumuje zestawy robocze / RSS; wspólne strony mogą być liczone wielokrotnie. CPU względem całej mocy komputera; nowe procesy wymagają dwóch próbek.",
  'performance.updated': "Aktualizacja {time}",
  ...
  'markdownRenderer.diagram.downloadPng': 'Pobierz PNG',
  'markdownRenderer.diagram.downloadSource': 'Pobierz źródło',
  'markdownRenderer.diagram.renderFailed': 'Nie udało się wyrenderować diagramu. Źródło jest pokazane poniżej.',
  'markdownRenderer.diagram.exportFailed': 'Nie udało się wyeksportować diagramu.',
