...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.occupancy.title": "Ocupação de desempenho",
  "settings.openchamber.occupancy.scenario.label": "Trabalho em segundo plano",
  "settings.openchamber.occupancy.scenario.info": "Escolha um trabalho, desligue-o ou limite quantos diffs git ele pode iniciar ao mesmo tempo.",
  "settings.openchamber.occupancy.scenario.aria": "Selecionar o trabalho em segundo plano a configurar",
  "settings.openchamber.occupancy.scenario.gitDiffPrefetch": "Pré-carregamento de diffs Git",
  "settings.openchamber.occupancy.scenario.walkthroughUntrackedDiffs": "Diffs de arquivos não rastreados do walkthrough",
  "settings.openchamber.occupancy.scenario.hiddenSurfaceWork": "Continuar o trabalho dos painéis walkthrough ocultos",
  "settings.openchamber.occupancy.scenario.browserTabKeepAlive": "Manter abas do navegador vivas",
  "settings.openchamber.occupancy.scenario.idlePolling": "Consulta de status ociosa",
  "settings.openchamber.occupancy.enabled": "Permitir este trabalho",
  "settings.openchamber.occupancy.enabledAria": "Permitir o trabalho em segundo plano selecionado",
  "settings.openchamber.occupancy.concurrency": "Diffs simultâneos máx.",
  "settings.openchamber.occupancy.concurrencyAria": "Número máximo de diffs git simultâneos",
  "settings.openchamber.occupancy.concurrencyInfo": "Quantos diffs de arquivo o painel Git pode pré-carregar de uma vez.",
  "settings.openchamber.occupancy.untrackedConcurrencyInfo": "Quantos arquivos não rastreados um walkthrough pode difer de uma vez.",
  "settings.openchamber.occupancy.maxFiles": "Arquivos não rastreados máx.",
  "settings.openchamber.occupancy.maxFilesAria": "Máximo de arquivos não rastreados para difer",
  "settings.openchamber.occupancy.maxFilesInfo": "A geração do walkthrough para depois deste número de arquivos não rastreados.",
  "settings.openchamber.occupancy.info.gitDiffPrefetch": "Desligado, o Git não pré-carrega mais diffs em segundo plano. Abra um arquivo para carregar o diff.",
  "settings.openchamber.occupancy.info.walkthroughUntrackedDiffs": "Desligado, o walkthrough ignora arquivos não rastreados em vez de difá-los contra uma árvore vazia.",
  "settings.openchamber.occupancy.info.hiddenSurfaceWork": "Desligado, uma aba de walkthrough oculta não carrega o status git nem gera diffs.",
  "settings.openchamber.occupancy.info.browserTabKeepAlive": "Desligado, só a aba do navegador ativa permanece montada. Voltar recarrega a página.",
  "settings.openchamber.occupancy.info.idlePolling": "Desligado, interrompe as consultas opcionais da bandeja e da árvore de arquivos. A recuperação do estado das sessões ativas continua.",
  ...
  'settings.openchamber.visual.field.mermaidStyle': 'Estilo Mermaid',
  'settings.openchamber.visual.field.mermaidStyleAria': 'Estilo Mermaid',
 'settings.openchamber.visual.option.mermaidStyle.openchamber': 'OpenChamber (padrão)',
 ...
 'settings.openchamber.visual.option.mermaidStyle.hand-drawn': 'Desenhado à mão',
  'settings.openchamber.visual.option.mermaidStyle.github-light': 'GitHub claro',
  'settings.openchamber.visual.option.mermaidStyle.github-dark': 'GitHub escuro',
  ...
  'settings.mcp.page.status.lastFailedAt': "Última falha: {time}",
  'settings.mcp.page.actions.viewLogs': "Ver logs",
  'settings.page.logs.title': "Logs",
  'settings.page.logs.description': "Logs de execução do OpenChamber para diagnóstico.",
  'settings.logs.section.title': "Arquivos de log",
  'settings.logs.currentFile': "Arquivo atual",
  'settings.logs.path': "Local",
  'settings.logs.openWithDefault': "Abrir com o programa padrão",
  'settings.logs.openFolder': "Mostrar na pasta",
  'settings.logs.download': "Baixar",
  'settings.logs.downloadFileAria': "Baixar {name}",
  'settings.logs.copyPath': "Copiar caminho",
  'settings.logs.copied': "Caminho copiado",
  'settings.logs.copyFailed': "Falha ao copiar o caminho",
  'settings.logs.openFailed': "Falha ao abrir o arquivo de log",
  'settings.logs.downloadFailed': "Falha ao baixar o arquivo de log",
  'settings.logs.empty': "Ainda não há arquivos de log.",
  'settings.logs.retainHint': "Os logs giram diariamente e os arquivos antigos são limpos automaticamente.",
  'settings.mcp.page.failure.windowsCmdShim.cause': "O comando não pôde ser iniciado no Windows (problema de shim do npm).",
  'settings.mcp.page.failureHint.windowsCmdShim': "No Windows, servidores locais baseados em npm geralmente rodam via cmd: use o comando cmd com os argumentos /c, npx e o seu pacote.",
  'settings.mcp.page.failure.commandNotFound.cause': "O comando ou pacote não foi encontrado.",
  'settings.mcp.page.failureHint.commandNotFound': "Verifique o comando e o nome do pacote, e certifique-se de que o runtime necessário está instalado e no PATH.",
  'settings.mcp.page.failure.connectionRefused.cause': "Não foi possível alcançar o endereço do servidor.",
  'settings.mcp.page.failureHint.connectionRefused': "Verifique URL, host e porta, e confirme que o servidor está em execução e acessível.",
  'settings.mcp.page.failure.processClosed.cause': "O processo do servidor fechou a conexão inesperadamente.",
  'settings.mcp.page.failureHint.processClosed': "Execute o comando manualmente em um terminal para ver o erro de inicialização — ele provavelmente travou ou encerrou imediatamente.",
  'settings.mcp.page.failure.timeout.cause': "O servidor não respondeu a tempo.",
  'settings.mcp.page.failureHint.timeout': "Aumente o tempo limite nas opções avançadas ou verifique se o servidor demora para iniciar.",
  'settings.mcp.page.failure.oauthRegistration.cause': "O registro do cliente OAuth foi rejeitado.",
  'settings.mcp.page.failureHint.oauthRegistration': "Registre um cliente no provedor ou informe um ID e segredo de cliente na seção de autorização.",
  'settings.mcp.page.failure.authRejected.cause': "O servidor rejeitou as credenciais.",
  'settings.mcp.page.failureHint.authRejected': "Verifique os cabeçalhos e variáveis de ambiente configurados: a chave de API ou o token deve ser válido.",
  'settings.mcp.page.failure.certificate.cause': "O certificado TLS não é confiável.",
  'settings.mcp.page.failureHint.certificate': "Corrija o certificado do servidor ou use um endpoint com cadeia de certificados confiável.",
  'settings.mcp.page.failure.wrongAddress.cause': "A URL do servidor não aponta para um endpoint válido.",
  'settings.mcp.page.failureHint.wrongAddress': "Confira a URL do servidor, incluindo o caminho do endpoint MCP (geralmente /mcp ou /sse).",
  'settings.logs.unavailable': "As informações de logs não estão disponíveis.",
