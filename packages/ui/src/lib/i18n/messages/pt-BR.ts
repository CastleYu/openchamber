...
export const dict: Record<I18nKey, string> = {
  'fileOpening.loading': "Carregando arquivo…",
  'fileOpening.previewFailed': "Não é possível visualizar. Tente novamente ou abra em um aplicativo do sistema.",
  'fileOpening.retry': "Tentar novamente",
  'fileOpening.archiveReadOnly': "Somente a lista de conteúdo. Nenhum arquivo é extraído.",
  'fileOpening.name': "Nome",
  'fileOpening.size': "Tamanho (bytes)",
  'fileOpening.compressed': "Comprimido (bytes)",
  'fileOpening.actionFailed': "Não foi possível concluir a operação.",
  'fileOpening.saveAs': "Salvar como…",
  'fileOpening.saved': "Cópia salva",
  'fileOpening.systemOpen': "Abrir no sistema",
  'fileOpening.chooseApp': "Escolher aplicativo…",
  'fileOpening.reveal': "Abrir pasta do arquivo",
  'fileOpening.unsaved': "Este arquivo tem alterações não salvas.",
  'fileOpening.openDisk': "Abrir versão salva",
  'fileOpening.saveOpen': "Salvar e abrir",
  'fileOpening.explorer': "Abrir no gerenciador de arquivos",
  'fileOpening.open': "Abrir",
  'performance.export': 'Exportar diagnóstico',
  'performance.title': "Desempenho",
  'performance.memory': "Memória",
  'performance.cpu': "CPU",
  'performance.processes': "Processos",
  'performance.metric': "Métrica do cabeçalho",
  'performance.paused': "Amostragem pausada",
  'performance.failed': "Falha na amostragem. Os dados anteriores podem estar desatualizados.",
  'performance.loading': "Coletando…",
  'performance.scope': "Servidor ativo e seus processos Electron, OpenCode, MCP e terminais. Exclui serviços externos e navegadores clientes.",
  'performance.pause': "Pausar",
  'performance.resume': "Retomar",
  'performance.history': "Últimas 30 amostras · a cada 5 segundos",
  'performance.accounting': "Memória soma conjuntos de trabalho / RSS; páginas compartilhadas podem ser duplicadas. CPU relativa à capacidade total; processos novos precisam de duas amostras.",
  'performance.updated': "Atualizado às {time}",
  ...
  ...settingsDict,
  'updateDialog.personalNotice': 'Versões pessoais apenas notificam atualizações. Sincronize o código e compile novamente para manter seus recursos.',
  ...
  "gitView.monitor.autoOn": "Monitor auto",
  "gitView.monitor.autoOff": "Pausado",
  "gitView.monitor.autoAria": "Ativar ou desativar o monitoramento automático do status git deste projeto",
  "gitView.monitor.autoTooltip": "Pausado, este projeto não pré-carrega diffs nem atualiza o status git em segundo plano. Use Atualizar para carregar a árvore atual.",
  "gitView.monitor.refresh": "Atualizar status git",
  "gitView.monitor.refreshAria": "Atualizar o status git deste projeto",
  ...
  "markdownRenderer.diagram.downloadPng": "Baixar PNG",
  "markdownRenderer.diagram.downloadSource": "Baixar fonte",
  "markdownRenderer.diagram.renderFailed": "Não foi possível renderizar o diagrama. A fonte é exibida abaixo.",
  "markdownRenderer.diagram.exportFailed": "Não foi possível exportar o diagrama.",
