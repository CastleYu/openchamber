...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.occupancy.title": "Зайнятість продуктивності",
  "settings.openchamber.occupancy.scenario.label": "Фонова робота",
  "settings.openchamber.occupancy.scenario.info": "Оберіть роботу, вимкніть її або обмежте, скільки git diff вона може запускати одночасно.",
  "settings.openchamber.occupancy.scenario.aria": "Вибрати фонову роботу для налаштування",
  "settings.openchamber.occupancy.scenario.gitDiffPrefetch": "Попереднє завантаження Git diff",
  "settings.openchamber.occupancy.scenario.walkthroughUntrackedDiffs": "Diff невідстежуваних файлів для walkthrough",
  "settings.openchamber.occupancy.scenario.hiddenSurfaceWork": "Продовжувати роботу прихованих панелей walkthrough",
  "settings.openchamber.occupancy.scenario.browserTabKeepAlive": "Тримати вкладки браузера живими",
  "settings.openchamber.occupancy.scenario.idlePolling": "Опитування стану в простої",
  "settings.openchamber.occupancy.enabled": "Дозволити цю роботу",
  "settings.openchamber.occupancy.enabledAria": "Дозволити вибрану фонову роботу",
  "settings.openchamber.occupancy.concurrency": "Макс. одночасних diff",
  "settings.openchamber.occupancy.concurrencyAria": "Максимальна кількість одночасних git diff",
  "settings.openchamber.occupancy.concurrencyInfo": "Скільки файлових diff панель Git може попередньо завантажити одночасно.",
  "settings.openchamber.occupancy.untrackedConcurrencyInfo": "Скільки невідстежуваних файлів walkthrough може порівняти одночасно.",
  "settings.openchamber.occupancy.maxFiles": "Макс. невідстежуваних файлів",
  "settings.openchamber.occupancy.maxFilesAria": "Максимум невідстежуваних файлів для diff",
  "settings.openchamber.occupancy.maxFilesInfo": "Генерація walkthrough зупиняється після такої кількості невідстежуваних файлів.",
  "settings.openchamber.occupancy.info.gitDiffPrefetch": "Вимкнено — Git більше не попередньо завантажує diff у фоні. Відкрийте файл, щоб завантажити його diff.",
  "settings.openchamber.occupancy.info.walkthroughUntrackedDiffs": "Вимкнено — walkthrough пропускає невідстежувані файли замість порівняння з порожнім деревом.",
  "settings.openchamber.occupancy.info.hiddenSurfaceWork": "Вимкнено — прихована вкладка walkthrough не завантажує стан git і не генерує diff.",
  "settings.openchamber.occupancy.info.browserTabKeepAlive": "Вимкнено — лишається лише активна вкладка браузера. Повернення перезавантажує сторінку.",
  "settings.openchamber.occupancy.info.idlePolling": "Вимкнення зупиняє необов’язкові опитування лотка й дерева файлів. Відновлення стану активних сесій залишається ввімкненим.",
  ...
  'settings.openchamber.visual.field.mermaidStyle': 'Стиль Mermaid',
  'settings.openchamber.visual.field.mermaidStyleAria': 'Стиль Mermaid',
 'settings.openchamber.visual.option.mermaidStyle.openchamber': 'OpenChamber (типовий)',
 'settings.openchamber.visual.option.mermaidStyle.native': 'Вбудований',
 'settings.openchamber.visual.option.mermaidStyle.forest': 'Forest',
 'settings.openchamber.visual.option.mermaidStyle.neutral': 'Нейтральний',
 'settings.openchamber.visual.option.mermaidStyle.hand-drawn': 'Намальований від руки',
  'settings.openchamber.visual.option.mermaidStyle.github-light': 'GitHub світлий',
  'settings.openchamber.visual.option.mermaidStyle.github-dark': 'GitHub темний',
  ...
  'settings.mcp.page.status.lastFailedAt': "Остання помилка: {time}",
  'settings.mcp.page.actions.viewLogs': "Переглянути журнали",
  'settings.page.logs.title': "Журнали",
  'settings.page.logs.description': "Журнали виконання OpenChamber для діагностики.",
  'settings.logs.section.title': "Файли журналу",
  'settings.logs.currentFile': "Поточний файл",
  'settings.logs.path': "Розташування",
  'settings.logs.openWithDefault': "Відкрити типовою програмою",
  'settings.logs.openFolder': "Показати в папці",
  'settings.logs.download': "Завантажити",
  'settings.logs.downloadFileAria': "Завантажити {name}",
  'settings.logs.copyPath': "Копіювати шлях",
  'settings.logs.copied': "Шлях скопійовано",
  'settings.logs.copyFailed': "Не вдалося скопіювати шлях",
  'settings.logs.openFailed': "Не вдалося відкрити файл журналу",
  'settings.logs.downloadFailed': "Не вдалося завантажити файл журналу",
  'settings.logs.empty': "Файлів журналу ще немає.",
  'settings.logs.retainHint': "Журнали ротуються щодня, старі файли видаляються автоматично.",
  'settings.mcp.page.failure.windowsCmdShim.cause': "Не вдалося запустити команду у Windows (проблема з shim npm).",
  'settings.mcp.page.failureHint.windowsCmdShim': "У Windows локальні сервери на основі npm зазвичай запускають через cmd: вкажіть команду cmd з аргументами /c, npx та назвою вашого пакета.",
  'settings.mcp.page.failure.commandNotFound.cause': "Команду або пакет не знайдено.",
  'settings.mcp.page.failureHint.commandNotFound': "Перевірте команду та назву пакета, а також переконайтеся, що потрібне середовище виконання встановлено і є в PATH.",
  'settings.mcp.page.failure.connectionRefused.cause': "Не вдалося з'єднатися з адресою сервера.",
  'settings.mcp.page.failureHint.connectionRefused': "Перевірте URL, хост і порт, а також переконайтеся, що сервер запущено та він доступний.",
  'settings.mcp.page.failure.processClosed.cause': "Процес сервера неочікувано закрив з'єднання.",
  'settings.mcp.page.failureHint.processClosed': "Запустіть команду вручну в терміналі, щоб побачити помилку запуску — ймовірно, вона зазнала аварії або одразу завершилася.",
  'settings.mcp.page.failure.timeout.cause': "Сервер не відповів вчасно.",
  'settings.mcp.page.failureHint.timeout': "Збільште час очікування в розширених параметрах або перевірте, чи сервер повільно запускається.",
  'settings.mcp.page.failure.oauthRegistration.cause': "Реєстрацію клієнта OAuth відхилено.",
  'settings.mcp.page.failureHint.oauthRegistration': "Зареєструйте клієнта у провайдера або вкажіть ідентифікатор і секрет клієнта в розділі авторизації.",
  'settings.mcp.page.failure.authRejected.cause': "Сервер відхилив облікові дані.",
  'settings.mcp.page.failureHint.authRejected': "Перевірте налаштовані заголовки та змінні середовища: ключ API або токен має бути чинним.",
  'settings.mcp.page.failure.certificate.cause': "Сертифікат TLS не викликає довіри.",
  'settings.mcp.page.failureHint.certificate': "Виправте сертифікат сервера або використовуйте кінцеву точку з довіреним ланцюжком сертифікатів.",
  'settings.mcp.page.failure.wrongAddress.cause': "URL сервера не вказує на дійсну кінцеву точку.",
  'settings.mcp.page.failureHint.wrongAddress': "Перевірте URL сервера, зокрема шлях кінцевої точки MCP (зазвичай /mcp або /sse).",
  'settings.logs.unavailable': "Інформація журналу недоступна.",
