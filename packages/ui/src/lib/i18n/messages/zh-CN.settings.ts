...
export const settingsDict = {
  ...
  'settings.history.personal': "个人版",
  'settings.history.surface': "应用",
  'settings.history.app': "主应用",
  'settings.history.new': "新增",
  'settings.history.improvements': "改进",
  'settings.history.fixes': "修复",
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.occupancy.title': '性能占用',
  'settings.openchamber.occupancy.scenario.label': '后台工作',
  'settings.openchamber.occupancy.scenario.info': '先选一类后台工作，再关掉它，或限制它同时能跑多少个 git diff。',
  'settings.openchamber.occupancy.scenario.aria': '选择要配置的后台工作',
  'settings.openchamber.occupancy.scenario.gitDiffPrefetch': 'Git diff 预取',
  'settings.openchamber.occupancy.scenario.walkthroughUntrackedDiffs': 'Walkthrough 未跟踪文件 diff',
  "settings.openchamber.occupancy.scenario.hiddenSurfaceWork": "隐藏的 Walkthrough 面板继续工作",
  'settings.openchamber.occupancy.scenario.browserTabKeepAlive': '保持浏览器标签存活',
  'settings.openchamber.occupancy.scenario.idlePolling': '空闲状态轮询',
  'settings.openchamber.occupancy.enabled': '允许这项工作',
  'settings.openchamber.occupancy.enabledAria': '允许所选的后台工作',
  'settings.openchamber.occupancy.concurrency': '最大并发 diff 数',
  'settings.openchamber.occupancy.concurrencyAria': 'git diff 的最大并发数',
  'settings.openchamber.occupancy.concurrencyInfo': 'Git 面板同时预取多少个文件 diff。',
  'settings.openchamber.occupancy.untrackedConcurrencyInfo': 'Walkthrough 同时为多少个未跟踪文件生成 diff。',
  'settings.openchamber.occupancy.maxFiles': '最多未跟踪文件',
  'settings.openchamber.occupancy.maxFilesAria': '最多为多少个未跟踪文件生成 diff',
  'settings.openchamber.occupancy.maxFilesInfo': 'Walkthrough 生成在处理这么多个未跟踪文件后停止。',
  'settings.openchamber.occupancy.info.gitDiffPrefetch': '关掉后，Git 不再后台预载文件 diff。打开文件时再加载。',
  'settings.openchamber.occupancy.info.walkthroughUntrackedDiffs': '关掉后，Walkthrough 跳过未跟踪文件，不再相对空树逐个 diff。',
  'settings.openchamber.occupancy.info.hiddenSurfaceWork': '关掉后，隐藏的 Walkthrough 标签不会加载 git 状态或生成 diff。',
  'settings.openchamber.occupancy.info.browserTabKeepAlive': '关掉后只保留当前浏览器标签。切回去会重新加载页面。',
  "settings.openchamber.occupancy.info.idlePolling": "关掉后停止托盘和文件树的可选轮询，保留活跃会话的状态恢复检查。",
  ...
  'settings.openchamber.visual.field.mermaidStyle': 'Mermaid 样式',
  'settings.openchamber.visual.field.mermaidStyleAria': 'Mermaid 样式',
 'settings.openchamber.visual.option.mermaidStyle.openchamber': 'OpenChamber（默认）',
  'settings.openchamber.visual.option.mermaidStyle.native': '原生',
  ...
  'settings.openchamber.visual.option.mermaidStyle.hand-drawn': '手绘',
  'settings.openchamber.visual.option.mermaidStyle.github-light': 'GitHub 浅色',
  'settings.openchamber.visual.option.mermaidStyle.github-dark': 'GitHub 深色',
  ...
  'settings.mcp.page.status.lastFailedAt': "上次失败：{time}",
  'settings.mcp.page.actions.viewLogs': "查看日志",
  'settings.page.logs.title': "日志",
  'settings.page.logs.description': "OpenChamber 运行日志，用于排查问题。",
  'settings.logs.section.title': "日志文件",
  'settings.logs.currentFile': "当前文件",
  'settings.logs.path': "位置",
  'settings.logs.openWithDefault': "用默认程序打开",
  'settings.logs.openFolder': "在文件夹中显示",
  'settings.logs.download': "下载",
  'settings.logs.downloadFileAria': "下载 {name}",
  'settings.logs.copyPath': "复制路径",
  'settings.logs.copied': "路径已复制",
  'settings.logs.copyFailed': "复制路径失败",
  'settings.logs.openFailed': "打开日志文件失败",
  'settings.logs.downloadFailed': "下载日志文件失败",
  'settings.logs.empty': "暂无日志文件。",
  'settings.logs.retainHint': "日志按天滚动，旧文件会自动清理。",
  'settings.mcp.page.failure.windowsCmdShim.cause': "命令在 Windows 上无法启动（npm shim 问题）。",
  'settings.mcp.page.failureHint.windowsCmdShim': "在 Windows 上，基于 npm 的本地服务器通常需要通过 cmd 运行：把命令设为 cmd，参数依次为 /c、npx 以及你的包名。",
  'settings.mcp.page.failure.commandNotFound.cause': "找不到命令或依赖包。",
  'settings.mcp.page.failureHint.commandNotFound': "检查命令和包名，确认所需运行时已安装并在 PATH 中。",
  'settings.mcp.page.failure.connectionRefused.cause': "无法连接到服务器地址。",
  'settings.mcp.page.failureHint.connectionRefused': "检查 URL、主机和端口，确认服务器正在运行且可达。",
  'settings.mcp.page.failure.processClosed.cause': "服务器进程意外关闭了连接。",
  'settings.mcp.page.failureHint.processClosed': "在终端手动运行该命令查看启动错误——它可能已崩溃或立即退出。",
  'settings.mcp.page.failure.timeout.cause': "服务器未在时限内响应。",
  'settings.mcp.page.failureHint.timeout': "在高级选项中增大超时时间，或检查服务器是否启动缓慢。",
  'settings.mcp.page.failure.oauthRegistration.cause': "OAuth 客户端注册被拒绝。",
  'settings.mcp.page.failureHint.oauthRegistration': "向提供商注册客户端，或在授权部分填写客户端 ID 和密钥。",
  'settings.mcp.page.failure.authRejected.cause': "服务器拒绝了凭据。",
  'settings.mcp.page.failureHint.authRejected': "检查已配置的请求头和环境变量中的 API 密钥或令牌是否有效。",
  'settings.mcp.page.failure.certificate.cause': "TLS 证书不可信。",
  'settings.mcp.page.failureHint.certificate': "修复服务器证书，或改用证书链可信的端点。",
  'settings.mcp.page.failure.wrongAddress.cause': "服务器 URL 未指向有效的端点。",
  'settings.mcp.page.failureHint.wrongAddress': "核对服务器 URL，包括 MCP 端点路径（通常是 /mcp 或 /sse）。",
  'settings.logs.unavailable': "日志信息不可用。",
