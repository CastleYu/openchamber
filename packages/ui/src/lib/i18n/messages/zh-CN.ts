...
export const dict: Record<I18nKey, string> = {
  ...
  'fileOpening.previewFailed': "无法预览此文件，请重试或使用系统应用打开。",
  'fileOpening.retry': "重试",
  'fileOpening.archiveReadOnly': "仅展示压缩包目录，不解压文件。",
  'fileOpening.name': "名称",
  'fileOpening.size': "大小（字节）",
  'fileOpening.compressed': "压缩后（字节）",
  'fileOpening.actionFailed': "文件操作未能完成。",
  'fileOpening.saveAs': "另存为…",
  'fileOpening.saved': "副本已保存",
  'fileOpening.systemOpen': "系统打开",
  'fileOpening.chooseApp': "选择应用…",
  'fileOpening.reveal': "打开目标文件夹",
  'fileOpening.unsaved': "此文件有未保存的修改。",
  'fileOpening.openDisk': "打开磁盘版本",
  'fileOpening.saveOpen': "保存并打开",
  'fileOpening.explorer': "在资源管理器中打开",
  'fileOpening.open': "打开",
  'performance.export': '导出诊断日志',
  ...
  'gitView.monitor.autoOn': '自动监控',
  'gitView.monitor.autoOff': '已暂停',
  'gitView.monitor.autoAria': '切换此项目的自动 git 状态监控',
  'gitView.monitor.autoTooltip': '暂停后，此项目不会预取 diff，也不会在后台刷新 git 状态。用刷新按钮加载当前工作区。',
  'gitView.monitor.refresh': '刷新 git 状态',
  'gitView.monitor.refreshAria': '刷新此项目的 git 状态',
  ...
  'markdownRenderer.diagram.downloadPng': '下载 PNG',
  'markdownRenderer.diagram.downloadSource': '下载源码',
  'markdownRenderer.diagram.renderFailed': '无法渲染图表，源码显示如下。',
  'markdownRenderer.diagram.exportFailed': '无法导出图表。',
