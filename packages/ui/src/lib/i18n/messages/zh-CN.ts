...
export const dict: Record<I18nKey, string> = {
  ...
  'quota.window.5h': '5小时',
  'quota.window.7d': '7天限制',
  'quota.window.7dSonnet': '7天 Sonnet 限制',
  'quota.window.7dOpus': '7天 Opus 限制',
  ...
  'quota.window.premium': '高级交互次数',
  'quota.window.chat': '聊天请求',
  'quota.window.completions': '文本补全',
  'quota.window.premiumInteractions': '高级交互次数',
};
