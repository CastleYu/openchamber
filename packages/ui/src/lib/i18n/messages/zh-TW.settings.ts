...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.occupancy.title': '效能占用',
  'settings.openchamber.occupancy.scenario.label': '背景工作',
  'settings.openchamber.occupancy.scenario.info': '先選一類背景工作，再關掉它，或限制它同時能跑多少個 git diff。',
  'settings.openchamber.occupancy.scenario.aria': '選擇要設定的背景工作',
  'settings.openchamber.occupancy.scenario.gitDiffPrefetch': 'Git diff 預取',
  'settings.openchamber.occupancy.scenario.walkthroughUntrackedDiffs': 'Walkthrough 未追蹤檔案 diff',
  "settings.openchamber.occupancy.scenario.hiddenSurfaceWork": "隱藏的 Walkthrough 面板繼續工作",
  'settings.openchamber.occupancy.scenario.browserTabKeepAlive': '保持瀏覽器分頁存活',
  'settings.openchamber.occupancy.scenario.idlePolling': '閒置狀態輪詢',
  'settings.openchamber.occupancy.enabled': '允許這項工作',
  'settings.openchamber.occupancy.enabledAria': '允許所選的背景工作',
  'settings.openchamber.occupancy.concurrency': '最大並發 diff 數',
  'settings.openchamber.occupancy.concurrencyAria': 'git diff 的最大並發數',
  'settings.openchamber.occupancy.concurrencyInfo': 'Git 面板同時預取多少個檔案 diff。',
  'settings.openchamber.occupancy.untrackedConcurrencyInfo': 'Walkthrough 同時為多少個未追蹤檔案產生 diff。',
  'settings.openchamber.occupancy.maxFiles': '最多未追蹤檔案',
  'settings.openchamber.occupancy.maxFilesAria': '最多為多少個未追蹤檔案產生 diff',
  'settings.openchamber.occupancy.maxFilesInfo': 'Walkthrough 產生在處理這麼多個未追蹤檔案後停止。',
  'settings.openchamber.occupancy.info.gitDiffPrefetch': '關掉後，Git 不再背景預載檔案 diff。開啟檔案時再載入。',
  'settings.openchamber.occupancy.info.walkthroughUntrackedDiffs': '關掉後，Walkthrough 跳過未追蹤檔案，不再相對空樹逐個 diff。',
  'settings.openchamber.occupancy.info.hiddenSurfaceWork': '關掉後，隱藏的 Walkthrough 分頁不會載入 git 狀態或產生 diff。',
  'settings.openchamber.occupancy.info.browserTabKeepAlive': '關掉後只保留目前瀏覽器分頁。切回去會重新載入頁面。',
  "settings.openchamber.occupancy.info.idlePolling": "關掉後停止系統匣和檔案樹的選用輪詢，保留使用中工作階段的狀態恢復檢查。",
  ...
  'settings.openchamber.visual.field.mermaidStyle': 'Mermaid 樣式',
  'settings.openchamber.visual.field.mermaidStyleAria': 'Mermaid 樣式',
 'settings.openchamber.visual.option.mermaidStyle.openchamber': 'OpenChamber（預設）',
  ...
  'settings.openchamber.visual.option.mermaidStyle.hand-drawn': '手繪',
  'settings.openchamber.visual.option.mermaidStyle.github-light': 'GitHub 淺色',
  ...
  'settings.mcp.page.status.lastFailedAt': "上次失敗：{time}",
  'settings.mcp.page.actions.viewLogs': "檢視日誌",
  'settings.page.logs.title': "日誌",
  'settings.page.logs.description': "OpenChamber 執行日誌，用於排查問題。",
  'settings.logs.section.title': "日誌檔案",
  'settings.logs.currentFile': "目前檔案",
  'settings.logs.path': "位置",
  'settings.logs.openWithDefault': "以預設程式開啟",
  'settings.logs.openFolder': "在資料夾中顯示",
  'settings.logs.download': "下載",
  'settings.logs.downloadFileAria': "下載 {name}",
  'settings.logs.copyPath': "複製路徑",
  'settings.logs.copied': "路徑已複製",
  'settings.logs.copyFailed': "複製路徑失敗",
  'settings.logs.openFailed': "開啟日誌檔案失敗",
  'settings.logs.downloadFailed': "下載日誌檔案失敗",
  'settings.logs.empty': "尚無日誌檔案。",
  'settings.logs.retainHint': "日誌按天輪替，舊檔案會自動清理。",
  'settings.mcp.page.failure.windowsCmdShim.cause': "命令在 Windows 上無法啟動（npm shim 問題）。",
  'settings.mcp.page.failureHint.windowsCmdShim': "在 Windows 上，以 npm 為基礎的本機伺服器通常需要透過 cmd 執行：把指令設為 cmd，參數依序為 /c、npx 與你的套件名稱。",
  'settings.mcp.page.failure.commandNotFound.cause': "找不到命令或相依套件。",
  'settings.mcp.page.failureHint.commandNotFound': "檢查指令與套件名稱，確認所需的執行環境已安裝並在 PATH 中。",
  'settings.mcp.page.failure.connectionRefused.cause': "無法連線到伺服器位址。",
  'settings.mcp.page.failureHint.connectionRefused': "檢查 URL、主機與連接埠，確認伺服器正在執行且可連線。",
  'settings.mcp.page.failure.processClosed.cause': "伺服器處理程序意外關閉了連線。",
  'settings.mcp.page.failureHint.processClosed': "在終端機手動執行該指令以查看啟動錯誤——它可能已當掉或立即結束。",
  'settings.mcp.page.failure.timeout.cause': "伺服器未在時限內回應。",
  'settings.mcp.page.failureHint.timeout': "在進階選項中增加逾時時間，或檢查伺服器是否啟動緩慢。",
  'settings.mcp.page.failure.oauthRegistration.cause': "OAuth 用戶端註冊被拒絕。",
  'settings.mcp.page.failureHint.oauthRegistration': "向提供者註冊用戶端，或在授權區塊填入用戶端 ID 與密鑰。",
  'settings.mcp.page.failure.authRejected.cause': "伺服器拒絕了憑證。",
  'settings.mcp.page.failureHint.authRejected': "檢查已設定的標頭與環境變數中的 API 金鑰或權杖是否有效。",
  'settings.mcp.page.failure.certificate.cause': "TLS 憑證不受信任。",
  'settings.mcp.page.failureHint.certificate': "修復伺服器憑證，或改用憑證鏈可信的端點。",
  'settings.mcp.page.failure.wrongAddress.cause': "伺服器 URL 未指向有效的端點。",
  'settings.mcp.page.failureHint.wrongAddress': "核對伺服器 URL，包括 MCP 端點路徑（通常是 /mcp 或 /sse）。",
  'settings.logs.unavailable': "日誌資訊不可用。",
