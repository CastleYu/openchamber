...
export const dict: Record<I18nKey, string> = {
  ...
  'fileOpening.previewFailed': "無法預覽此檔案，請重試或使用系統應用程式開啟。",
  'fileOpening.retry': "重試",
  'fileOpening.archiveReadOnly': "僅顯示壓縮檔目錄，不解壓縮檔案。",
  'fileOpening.name': "名稱",
  'fileOpening.size': "大小（位元組）",
  'fileOpening.compressed': "壓縮後（位元組）",
  'fileOpening.actionFailed': "無法完成檔案操作。",
  'fileOpening.saveAs': "另存新檔…",
  'fileOpening.saved': "副本已儲存",
  'fileOpening.systemOpen': "系統開啟",
  'fileOpening.chooseApp': "選擇應用程式…",
  'fileOpening.reveal': "開啟所在資料夾",
  'fileOpening.unsaved': "此檔案有未儲存的變更。",
  'fileOpening.openDisk': "開啟磁碟版本",
  'fileOpening.saveOpen': "儲存並開啟",
  'fileOpening.explorer': "在檔案總管中開啟",
  'fileOpening.open': "開啟",
  'performance.export': '匯出診斷記錄',
  'performance.title': "效能分析",
  'performance.memory': "記憶體",
  'performance.cpu': "CPU",
  'performance.processes': "程序數",
  'performance.metric': "頂部顯示指標",
  'performance.paused': "取樣已暫停",
  'performance.failed': "取樣失敗，先前資料可能已過期。",
  'performance.loading': "正在取樣…",
  'performance.scope': "目前服務及其 Electron、OpenCode、MCP、終端程序樹。外部服務和瀏覽器用戶端不計入。",
  'performance.pause': "暫停",
  'performance.resume': "繼續",
  'performance.history': "最近 30 次取樣 · 每 5 秒一次",
  'performance.accounting': "記憶體為工作集 / RSS 總和，共用頁面可能重複計入。CPU 依整機算力計算，新程序需要兩次取樣。",
  'performance.updated': "更新於 {time}",
  ...
  'markdownRenderer.diagram.downloadPng': '下載 PNG',
  'markdownRenderer.diagram.downloadSource': '下載原始碼',
  'markdownRenderer.diagram.renderFailed': '無法轉譯圖表，原始碼如下所示。',
  'markdownRenderer.diagram.exportFailed': '無法匯出圖表。',
