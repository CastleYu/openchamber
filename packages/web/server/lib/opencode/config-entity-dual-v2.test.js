...
const { parseMdFile } = await import('./shared-v2.js');
const { getAgentConfig, getAgentPermissions, updateAgent, createAgent } = await import('./agents-v2.js');
const { getCommandConfig, updateCommand } = await import('./commands-v2.js');
const { getMcpConfig, listMcpConfigs, updateMcpConfig } = await import('./mcp-v2.js');
