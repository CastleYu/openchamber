...
// The fixture is a POSIX shell installer; Windows packaging verifies its own
// bundled OpenCode executable through the portable build instead.
describe.skipIf(process.platform === 'win32')('OpenCode v2 installation', () => {
