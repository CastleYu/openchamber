...
export default defineConfig({
  ...
  test: {
    ...
    exclude: [...configDefaults.exclude,
      'server/lib/fs/zip-directory.test.js',
      'server/lib/mcp-reconnect/resource-modes.test.js',
      'server/lib/performance/collector.test.js',
      'server/lib/performance/windows-processes.test.js',
    ],
